...
#$secret = ""
$AzureSubscriptionName = "sub-trg-evaluation"
...
$secret = Get-AzureKeyVaultSecret -VaultName $KeyVaultName -Name "AzureCredentialSecret"
$secretValue = $secret.SecretValueText
$azureCredential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $secretValue.Split(":")[0], (ConvertTo-SecureString $secretValue.Split(":")[1] -AsPlainText -Force)
Write-Output "Retrieved credentials from Key Vault for user: [$($azureCredential.UserName)]"
